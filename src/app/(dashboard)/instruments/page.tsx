  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Instrumentos de medición de clima organizacional</p>
      </div>
      ...
      {instruments.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground">No hay instrumentos registrados</p>
          </CardContent>
        </Card>
      ) : (
        <div className="grid gap-4 md:grid-cols-2">
          {instruments.map((instrument) => (
            <Link key={instrument.id} href={`/instruments/${instrument.id}`}>
              <Card className="transition-colors hover:bg-muted/50">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Badge variant={instrument.mode === "full" ? "default" : "secondary"}>
                ...
                <CardContent>
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Badge variant={instrument.is_active ? "default" : "destructive"}>
